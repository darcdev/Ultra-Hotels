...
import { EditHotelModalComponent } from '@/app/presenter/views/pages/travel-agent/travel-agent-page/components/manage-hotels-view/hotel/edit-new-hotel-modal/edit-hotel-modal.component';
