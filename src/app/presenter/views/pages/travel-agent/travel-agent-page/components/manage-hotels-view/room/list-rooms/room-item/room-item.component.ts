...
import { HotelConfigurationComponent } from '@/app/presenter/views/pages/travel-agent/travel-agent-page/components/manage-hotels-view/hotel/list-hotels/hotel-configuration/hotel-configuration.component';
import { IconComponent } from '@/app/presenter/views/shared/components/design-system/atoms/icon/icon.component';
import { PrimeTemplate } from 'primeng/api';
import { TagModule } from 'primeng/tag';
import { RoomHotelConfigurationComponent } from '@/app/presenter/views/pages/travel-agent/travel-agent-page/components/manage-hotels-view/room/list-rooms/room-hotel-configuration/room-hotel-configuration.component';
