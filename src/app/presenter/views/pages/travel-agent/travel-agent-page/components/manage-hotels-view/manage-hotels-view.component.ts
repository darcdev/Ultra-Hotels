...
import { ListHotelsComponent } from '@/app/presenter/views/pages/travel-agent/travel-agent-page/components/manage-hotels-view/hotel/list-hotels/list-hotels.component';
import { DialogService, DynamicDialogRef } from 'primeng/dynamicdialog';
import { CreateNewHotelModalComponent } from '@/app/presenter/views/pages/travel-agent/travel-agent-page/components/manage-hotels-view/hotel/create-new-hotel-modal/create-new-hotel-modal.component';
